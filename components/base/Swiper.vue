<template>
  <swiper class="mySwiper" :loop="true" :loopFillGroupWithBlank="true" :modules="modules" :slides-per-view="1"
    ...
    <swiper-slide v-for="item in items">
      <div class="px-4 pb-10 w-80 flex justify-center items-center gap-2 flex-col">
        ...
        <p class="text-xs">Sea chub demoiselle whalefish zebra lionfish mud cat pelican eel. Minnow snoek icefish
          velvet-belly shark,
          California
...
export default {
  ...
  data () {
    return {
      items: [ { name: 'Danielle', title: "Frontend Developer" }, { name: 'Evelyn', title: "Project Manager" }, { name: 'Marrianne', title: "Founder of Mary's Marrianne" }, ]
    }
  },
  setup () {
